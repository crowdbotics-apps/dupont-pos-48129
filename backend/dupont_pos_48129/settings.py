"""
Django settings for dupont_pos_48129 project.
...
ROOT_URLCONF = 'dupont_pos_48129.urls'
...
WSGI_APPLICATION = 'dupont_pos_48129.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dupont_pos_48129 API",
    "DESCRIPTION": "API documentation for dupont_pos_48129 App",
    "VERSION": "v1",
}
